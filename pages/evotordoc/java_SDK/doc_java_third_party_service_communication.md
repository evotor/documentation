...
2. На вкладке **Интеграция**, установите флажок **Проксирование запросов из приложения с терминала на ваш сервер** и укажите список доменов с указанием протокола, к которым может обращаться приложение.
