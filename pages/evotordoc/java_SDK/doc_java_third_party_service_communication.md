...
{% include note.html content="Установленные на смарт-терминале приложения могут обращаться только к сторонним сервисам. Обращаться к REST API Облака Эвотор нельзя." %}
