...
{% include note.html content="Обмен сообщениями со сторонним сервисом возможен только если вы установили приложение из [Магазина приложений](./doc_app_installation.html#MarkeplaceAppInstallation)." %}
